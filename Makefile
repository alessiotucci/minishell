...
#    Updated: 2023/12/21 12:34:55 by atucci           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
cleanhidden:
	@echo "$(YELLOW) Listing hidden files: $(RESET)"
	@find . \( -name ".DS_Store" -o -name ".*.swp" \) -type f -print
	@echo "$(RED) Deleting hidden files: $(RESET)"
	@find . \( -name ".DS_Store" -o -name ".*.swp" \) -type f -delete
	@echo "$(GREEN) Hidden files deleted $(RESET)"
